namespace Runemark.VisualEditor
{
	...
	public class NodeInspector : Editor
	{
        ...
        protected override void OnHeaderGUI()
        {
            ...
            RunemarkGUI.inspectorTitle.Draw(StringUtils.AddSpacesToSentence(myTarget.GetType().Name) + " (Action)", "");

            //DialogueSystemGUIStyle.DrawInspectorTitle(StringUtils.AddSpacesToSentence(myTarget.GetType().Name) + " (Action)", "");
        }
